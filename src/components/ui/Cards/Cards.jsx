    ...
    <div className="flex justify-center rounded-lg bg-white">
      <div className="border-2 border-gray-300 h-[400px] w-72 m-12 rounded-lg p-4">
        ...
        <p className="mt-2 text-sm">
          {props.text} <span className="text-blue-600 font-medium">{props.time1}</span> <br />
          {props.text}<span className="text-blue-600 font-medium">{props.time2}</span>
        </p>
        <h4 className=" w-20 mt-2 ml-2 text-white bg-red-600 font-semibold">• Live</h4>
