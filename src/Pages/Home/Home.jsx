...
const Home = () => {
  ...
  return (
    ...
    <div className='flex'> 
      <Para className='w-2/5 text-6xl m-20 text-blue-900 h-96 mt-40' text="Go Hackathon  Academic Alliance Initiative as " names={name}/>
      <img src="src/assets/images/hero-section-header-img.svg" className='h-96 mt-20'></img>
    </div>
    <div className='text-center '>
    <h1>Our Services</h1>
    <br></br>
    <br></br>
    <div className='flex justify-evenly flex-wrap w-4/5 m-auto mb-20'>
  <NavLink to='/services/worksops'> <ServiceCard img={images.a} name='Workshop'/></NavLink>
  <NavLink to='/Services/Webinars'> <ServiceCard img={images.b} name='Webinar'/></NavLink>
  <NavLink to='/services/trainings'> <ServiceCard img={images.c} name='Training'/></NavLink>
  <NavLink to='/services/startup'> <ServiceCard img={images.d} name='Mentorship program'/></NavLink>
  <NavLink to='/services/hackathons'> <ServiceCard img={images.e} name='Hackthons'/></NavLink>
  <NavLink to='/services/internships'> <ServiceCard img={images.f} name='Internship'/></NavLink>
  <NavLink to='/services/projects'> <ServiceCard img={images.g} name='Project'/></NavLink>
  <NavLink to='/services/placementsupport'> <ServiceCard img={images.h} name='Placement'/></NavLink>
  <NavLink to='/services/research'> <ServiceCard img={images.i} name='Research'/></NavLink>
    </div>
