  ...
  return (
    <div className="font-serif">
      ...
      <div className="flex w-[100%] justify-center">
        <img className="w-[60%]" src="/src/assets/images/research.png" alt="Research" />
      </div>
...
<div className='flex justify-center'>
        ...
        <h2 class="text-[35px] font-bold text-center mt-[70px] mb-8 ">
        <u>Importance of Continuous Learning</u>
      </h2>
      ...
      <div class="grid grid-cols-2 ">
        ...
        <div class="bg-gray-50 rounded-lg  p-6 h-full w-[80%] text-[20px]">
          <p className=''>
      ...
      <h2 class="text-[35px] font-bold text-center mt-16 mb-8">
