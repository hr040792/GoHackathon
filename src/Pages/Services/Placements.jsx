  ...
  return (
    <div className="font-serif">
      ...
      <div className="flex justify-evenly">
        <Para
          className="w-2/5 text-2xl m-10 text-blue-900 h-96"
        ...
        />
        <img
          src="/src/assets/images/placement.jpg"
          alt="Workshop"
      ...
      <div className="text-center">
        <Button text="weekdays" className="px-4 h-[60px] w-[200px] mb-[100px]" />
        <div className='flex justify-center'>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4  justify-center">
          {visibleCards.map((card, index) => (
            <div key={index} className="border border-gray-300 rounded-lg p-4 w-[350px] h-[420px] mx-2 my-4">
              <img src={card.imgurl} alt={card.topic} className="w-full h-40 object-cover border-2" />
        ...
        <button
          ...
          className="bg-blue-500 text-white px-10 py-3 text-xl rounded-[40px] mt-6"
